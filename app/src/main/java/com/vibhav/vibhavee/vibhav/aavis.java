...
//import com.vibhav.vibhavee.vibhav.registation.AavishkarRegistration;

public class aavis extends AppCompatActivity {
    private static Button about;
    String bucks_token ,event="aaviskar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.aavishkartemp);
    ...
    public void about(View view){
        about_builder= new AlertDialog.Builder(aavis.this);
        about_builder.setMessage(R.string.aboutt3);
    ...
    public void rules(View view){
        rules_builder= new AlertDialog.Builder(aavis.this);
        rules_builder.setMessage(R.string.rulest3);
    ...
    public void judgingCriteria(View view){
        judgingCriteria_builder= new AlertDialog.Builder(aavis.this);
        judgingCriteria_builder.setMessage(R.string.judgingCriteriat3);
    ...
    public void prizes(View view){
        prizes_builder= new AlertDialog.Builder(aavis.this);
        prizes_builder.setMessage(R.string.prizest3);
    ...
    public void contactUs(View view){
        contactUs_builder= new AlertDialog.Builder(aavis.this);
        contactUs_builder.setMessage(R.string.contactUst3);
    ...
    public void payments(View view){
        payment_builder= new AlertDialog.Builder(aavis.this);
        payment_builder.setMessage(R.string.paymentt3);
