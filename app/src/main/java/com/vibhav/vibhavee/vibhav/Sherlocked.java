...
public class Sherlocked extends AppCompatActivity {
    ...
    String bucks_token ,event="sherlocked";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.pub);
    ...
    public void about(View view){
        about_builder= new AlertDialog.Builder(Sherlocked.this);
        about_builder.setMessage(R.string.about101);
    ...
    public void rules(View view){
        rules_builder= new AlertDialog.Builder(Sherlocked.this);
        rules_builder.setMessage(R.string.rules101);
    ...
    public void judgingCriteria(View view){
        judgingCriteria_builder= new AlertDialog.Builder(Sherlocked.this);
        judgingCriteria_builder.setMessage(R.string.judgingCriteria101);
    ...
    public void prizes(View view){
        prizes_builder= new AlertDialog.Builder(Sherlocked.this);
    ...
    public void contactUs(View view){
        contactUs_builder= new AlertDialog.Builder(Sherlocked.this);
        contactUs_builder.setMessage(R.string.contactUs101);
